...
dotest(2.6, rrapply(xin, f = unlist, condition = function(x, .xname) .xname == "b", how = "replace", feverywhere = "break"), xout2.6)
dotest(2.7, rrapply(xin, f = unlist, condition = function(x, .xname) .xname == "b", how = "list", feverywhere = "break"), xout2.7)
dotest(2.8, rrapply(xin, f = unlist, condition = function(x, .xname) .xname == "b", how = "unlist", feverywhere = "break"), xout2.8)
dotest(2.9, rrapply(xin, f = unlist, condition = function(x, .xname) .xname == "b", how = "prune", feverywhere = "break"), xout2.9)
dotest(2.10, rrapply(xin, f = unlist, condition = function(x, .xname) .xname == "b", how = "flatten", feverywhere = "break"), xout2.10)
...
dotest(6.1, rrapply(xin, f = function(x, .xname) .xname, feverywhere = "break"), xout6.1)
dotest(6.2, rrapply(xin, f = function(x, .xname) .xname, condition = function(x, .xname) .xname == "b", feverywhere = "break"), xout6.2)
dotest(6.3, rrapply(xin, f = function(x, .xname) .xname, condition = function(x, .xpos) length(.xpos) == 2, feverywhere = "break"), xout6.3)
dotest(6.4, rrapply(xin, f = function(x, .xname) .xname, condition = function(x, .xpos) length(.xpos) == 3, feverywhere = "break"), xout6.4)
...
dotest(8.6, rrapply(xin, f = function(x, .xpos) -.xpos, condition = function(x, .xpos) .xpos %in% c(1L, length(xin)), feverywhere = "break"), xout8.6)
...
dotest(9.6, rrapply(xin, f = function(x, .xname) .xname, condition = function(x, .xname) nzchar(.xname), feverywhere = "break"), xout9.6)
...
dotest(10.6, rrapply(xin, f = function(x, .xname) .xname, condition = function(x, .xname) !is.na(.xname), feverywhere = "break"), xout10.6)
...
dotest(11.5, rrapply(xin1, condition = function(x) FALSE, how = "prune", feverywhere = "break"), xout11.1)
dotest(11.6, rrapply(xin1, condition = function(x) FALSE, how = "flatten", feverywhere = "break"), xout11.1)
...
dotest(11.11, rrapply(xin2, condition = function(x) FALSE, how = "prune", feverywhere = "break"), xout11.2)
dotest(11.12, rrapply(xin2, condition = function(x) FALSE, how = "flatten", feverywhere = "break"), xout11.2)
