...
dotest(2.6, rrapply(xin, f = unlist, condition = function(x) .xname == "b", how = "replace", feverywhere = TRUE), xout2.6)
dotest(2.7, rrapply(xin, f = unlist, condition = function(x) .xname == "b", how = "list", feverywhere = TRUE), xout2.7)
dotest(2.8, rrapply(xin, f = unlist, condition = function(x) .xname == "b", how = "unlist", feverywhere = TRUE), xout2.8)
dotest(2.9, rrapply(xin, f = unlist, condition = function(x) .xname == "b", how = "prune", feverywhere = TRUE), xout2.9)
dotest(2.10, rrapply(xin, f = unlist, condition = function(x) .xname == "b", how = "flatten", feverywhere = TRUE), xout2.10)
...
dotest(6.1, rrapply(xin, f = function(x) .xname, feverywhere = TRUE), xout6.1)
dotest(6.2, rrapply(xin, f = function(x) .xname, condition = function(x) .xname == "b", feverywhere = TRUE), xout6.2)
dotest(6.3, rrapply(xin, f = function(x) .xname, condition = function(x) length(.xpos) == 2, feverywhere = TRUE), xout6.3)
dotest(6.4, rrapply(xin, f = function(x) .xname, condition = function(x) length(.xpos) == 3, feverywhere = TRUE), xout6.4)
...
dotest(7.5, rrapply(xin, f = `-`, condition = function(x) .xpos %in% c(1L, length(xin)), feverywhere = TRUE), xout7.5)
...
dotest(8.1, rrapply(xin, f = `-`, condition = function(x) .xpos %in% c(1L, length(xin)), how = "replace"), xout8.1)
dotest(8.2, rrapply(xin, f = `-`, condition = function(x) .xpos %in% c(1L, length(xin)), how = "list"), xout8.2)
dotest(8.3, rrapply(xin, f = `-`, condition = function(x) .xpos %in% c(1L, length(xin)), how = "prune"), xout8.3)
dotest(8.4, rrapply(xin, f = `-`, condition = function(x) .xpos %in% c(1L, length(xin)), how = "flatten"), xout8.4)
dotest(8.5, rrapply(xin, f = `-`, condition = function(x) is.na(.xname)), xout8.5)
dotest(8.6, rrapply(xin, f = function(x) -.xpos, condition = function(x) .xpos %in% c(1L, length(xin)), feverywhere = TRUE), xout8.6)
...
dotest(9.1, rrapply(xin, f = `-`, condition = function(x) nzchar(.xname), how = "replace"), xout9.1)
dotest(9.2, rrapply(xin, f = `-`, condition = function(x) nzchar(.xname), how = "list"), xout9.2)
dotest(9.3, rrapply(xin, f = `-`, condition = function(x) nzchar(.xname), how = "prune"), xout9.3)
dotest(9.4, rrapply(xin, f = `-`, condition = function(x) nzchar(.xname), how = "flatten"), xout9.4)
dotest(9.5, rrapply(xin, f = `-`, condition = function(x) .xpos == 1L, how = "prune"), xout9.5)
dotest(9.6, rrapply(xin, f = function(x) .xname, condition = function(x) nzchar(.xname), feverywhere = TRUE), xout9.6)
...
dotest(10.1, rrapply(xin, f = `-`, condition = function(x) !is.na(.xname), how = "replace"), xout10.1)
dotest(10.2, rrapply(xin, f = `-`, condition = function(x) !is.na(.xname), how = "list"), xout10.2)
dotest(10.3, rrapply(xin, f = `-`, condition = function(x) !is.na(.xname), how = "prune"), xout10.3)
dotest(10.4, rrapply(xin, f = `-`, condition = function(x) !is.na(.xname), how = "flatten"), xout10.4)
dotest(10.5, rrapply(xin, f = `-`, condition = function(x) identical(.xpos, c(3L, 1L)), how = "prune"), xout10.5)
dotest(10.6, rrapply(xin, f = function(x) .xname, condition = function(x) !is.na(.xname), feverywhere = TRUE), xout10.6)
