...
@
Using the \code{dfaslist} argument is somewhat more concise and also slightly more efficient as the class of the list element is checked directly analogous to the \code{classes} argument. 
\end{remark}
