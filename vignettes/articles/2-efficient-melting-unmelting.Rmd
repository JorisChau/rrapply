...
For illustration purposes, we use the same dataset `renewable_energy_by_country` as in `vignette("when-to-use-rrapply")`, a nested list containing the per country shares of renewable energy as a percentage in the total energy consumption in 2016.
